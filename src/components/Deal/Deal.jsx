      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative flex justify-center order-2 lg:order-1">
            ...
            <div className="relative">
              ...
              <img
                ...
                style={{ filter: "drop-shadow(0 20px 50px rgba(250,86,49,0.35))" }}
              />
              <div className="absolute -top-3 -right-3 z-20 bg-[#fa5631] text-white text-xs font-black tracking-widest uppercase px-3 py-1.5">
                NEW!
              </div>
            </div>
          </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <h3 className="text-white/50 text-xl font-light mb-5">Why choose this?</h3>

            <p className="text-white/50 text-base leading-relaxed mb-8 max-w-lg">
              We're thrilled to introduce{" "}
              <strong className="text-white font-semibold">Ramen Noodles</strong> to our menu.
              Order the Ramen Noodles and get a{" "}
              <strong className="text-[#fa5631]">free Yogurt Smoothie</strong> — on us!
              Featuring rich broth, eggs, seasonal vegetables, and premium spices.
            </p>

            {/* Highlight card */}
            <div className="bg-white/5 border border-white/10 p-4 mb-8 flex items-start gap-4">
              <div className="w-10 h-10 bg-[#fa5631]/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                <svg className="w-5 h-5 text-[#fa5631]" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                </svg>
              </div>
              <div>
                <div className="text-white font-semibold text-sm mb-0.5">Free Yogurt Smoothie</div>
                <div className="text-white/40 text-sm">With every Ramen Noodles order. Today only.</div>
              </div>
            </div>

            <a
              href="/menu"
              className="inline-flex items-center gap-3 bg-[#fa5631] hover:bg-[#e04420] text-white font-semibold px-8 py-4 transition-all duration-300 hover:scale-105 active:scale-95 no-underline group"
            >
              Order Now

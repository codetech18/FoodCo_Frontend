...
const SuperAdminDashboard = () => {
  ...
  const fetchRestaurants = async () => {
    setLoading(true);
    try {
      // Drive the list from /users collection — every restaurant owner has a doc here
                ...
                <div className="flex items-center gap-4 px-5 py-4">
                  ...
                  <div className="flex-shrink-0">
                    {r.logoUrl ? (
                      ...
                      >
                        <span style={{ color: r.accentColor }}>
                          {r.name.charAt(0)}
                        </span>
                      </div>
                    )}
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    >
                      <svg
                        className={`w-3.5 h-3.5 transition-transform ${expandedId === r.restaurantId ? "rotate-180" : ""}`}
                        viewBox="0 0 24 24"
                        fill="none"
                        stroke="currentColor"
                        strokeWidth="2"
